...
export class NhlStarPlayerUtils {
  ...
  private static readonly starPlayersByTeamId: Record<number, TeamStarPlayers> = {
    ...
    16: {forwards: [8484144, 8474141, 8485391], defense: [8481524, 8484783]}, // CHI: Connor Bedard, Patrick Kane, Anton Frondell | Bowen Byram, Artyom Levshunov
    17: {forwards: [8479337, 8482078, 8477946], defense: [8481542, 8482762]}, // DET: Alex DeBrincat, Lucas Raymond, Dylan Larkin | Moritz Seider, Simon Edvinsson
    ...
    21: {forwards: [8477492, 8480039, 8475754], defense: [8480069, 8478038]}, // COL: Nathan MacKinnon, Martin Necas, Brock Nelson | Cale Makar, Devon Toews
    ...
    28: {forwards: [8484801, 8484227, 8485402], defense: [8484806, 8476885]}, // SJS: Macklin Celebrini, Will Smith, Michael Misa | Sam Dickinson, Jacob Trouba
