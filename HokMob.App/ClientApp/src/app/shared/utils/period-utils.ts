...
export class PeriodUtils {
  ...
  /**
   * Gets the status label for a live game, like "2nd - 5:32", "End 1st" or "SO". During an intermission the
   * periodDescriptor is the period that just ended, so the label is "End 1st".
   *
